...
// New Password page is a simple wrapper component
// Static analysis-based tests to verify component structure

describe("New Password Page Component", () => {
  ...
  describe("Basic Component Structure", () => {
    it("should export NewPasswordPage as default export", () => {
      const source = getComponentSource();
      expect(source).toContain("export default NewPasswordPage");
    });

    it("should be a functional component", () => {
      const source = getComponentSource();
      expect(source).toContain("const NewPasswordPage = () =>");
    });

    it("should be an arrow function component", () => {
      const source = getComponentSource();
      expect(source).toMatch(/const NewPasswordPage = \(\s*\) =>/);
    });
  ...
  describe("Component Imports", () => {
    it("should import NewPasswordForm component", () => {
      const source = getComponentSource();
      expect(source).toContain("from '@/components/auth/new-password-form'");
      expect(source).toContain("NewPasswordForm");
    });

    it("should import NewPasswordForm from correct path", () => {
      const source = getComponentSource();
      expect(source).toContain("import { NewPasswordForm }");
    });

    it("should use named import for NewPasswordForm", () => {
      const source = getComponentSource();
      expect(source).toMatch(/import { NewPasswordForm }/);
    });
  });

  describe("Component Rendering", () => {
    it("should render NewPasswordForm component", () => {
      const source = getComponentSource();
      expect(source).toContain("<NewPasswordForm />");
    });

    it("should render NewPasswordForm as self-closing tag", () => {
      const source = getComponentSource();
      expect(source).toContain("<NewPasswordForm />");
    });

    it("should return NewPasswordForm directly", () => {
      const source = getComponentSource();
      expect(source).toMatch(/return \([\s\S]*?<NewPasswordForm \/>/);
    });

    it("should not pass any props to NewPasswordForm", () => {
      const source = getComponentSource();
      expect(source).toMatch(/<NewPasswordForm \s*\/>/);
    });
  ...
  describe("Component Structure", () => {
    ...
    it("should have semicolon after component definition", () => {
      const source = getComponentSource();
      expect(source).toMatch(/};\s*export default NewPasswordPage/);
    });
  });

  describe("Component Name", () => {
    it("should be named NewPasswordPage", () => {
      const source = getComponentSource();
      expect(source).toContain("const NewPasswordPage");
    });

    it("should export NewPasswordPage", () => {
      const source = getComponentSource();
      expect(source).toContain("export default NewPasswordPage");
    });
    ...
    it("should use consistent naming", () => {
      const source = getComponentSource();
      const matches = source.match(/NewPasswordPage/g);
  ...
  describe("Code Style", () => {
    ...
    it("should use single quotes for import path", () => {
      const source = getComponentSource();
      expect(source).toContain("'@/components/auth/new-password-form'");
    });
  });
  ...
  describe("Export Statement", () => {
    ...
    it("should export NewPasswordPage component", () => {
      const source = getComponentSource();
      expect(source).toContain("export default NewPasswordPage");
    });
  ...
  describe("File Structure", () => {
    it("should have import statement first", () => {
      ...
      const componentIndex = source.indexOf("const NewPasswordPage");
  ...
  describe("Import Path", () => {
    ...
    it("should import from new-password-form file", () => {
      const source = getComponentSource();
      expect(source).toContain("new-password-form");
    });
  ...
  describe("Component Functionality", () => {
    it("should render only NewPasswordForm", () => {
      const source = getComponentSource();
      const formMatches = source.match(/<NewPasswordForm/g);
  ...
  describe("Component Definition", () => {
    it("should define component with const", () => {
      const source = getComponentSource();
      expect(source).toMatch(/const NewPasswordPage =/);
    });
  ...
  describe("Component Composition", () => {
    it("should compose NewPasswordForm component", () => {
      const source = getComponentSource();
      expect(source).toContain("NewPasswordForm");
    });

    it("should use imported NewPasswordForm", () => {
      const source = getComponentSource();
      const importMatch = source.match(/import.*NewPasswordForm/);
      const usageMatch = source.match(/<NewPasswordForm/);
  ...
  describe("Single Responsibility", () => {
    it("should only render NewPasswordForm", () => {
      const source = getComponentSource();
      expect(source).toContain("<NewPasswordForm />");
    });

    it("should delegate password functionality to NewPasswordForm", () => {
      const source = getComponentSource();
      expect(source).toContain("NewPasswordForm");
    });
  ...
  describe("JSX Structure", () => {
    it("should render NewPasswordForm as single element", () => {
      const source = getComponentSource();
      expect(source).toMatch(/return \([\s\S]*?<NewPasswordForm \/>\s*\)/);
    });
  ...
  describe("Component Isolation", () => {
    it("should only import NewPasswordForm", () => {
      const source = getComponentSource();
