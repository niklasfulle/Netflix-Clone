...
export async function GET() {
  ...
  const allDayKeys = Array.from(new Set([...Object.keys(movieCountsDay), ...Object.keys(seriesCountsDay)])).sort();
  ...
  const allMonthKeys = Array.from(new Set([...Object.keys(movieCountsMonth), ...Object.keys(seriesCountsMonth)])).sort();
