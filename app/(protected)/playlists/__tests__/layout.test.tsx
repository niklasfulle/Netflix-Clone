...
describe("Playlists Layout (playlists/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix - Playlists"', () => {
      expect(metadata.title).toBe("Netflix - Playlists");
    });
    ...
    it("should have Playlists text", () => {
      expect(metadata.title).toContain("Playlists");
    });
  });
  ...
  describe("Metadata Title", () => {
    ...
    it("should end with Playlists", () => {
      expect(metadata.title).toMatch(/Playlists$/);
    });
  });
