...
describe("Search Layout (search/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix - Search"', () => {
      expect(metadata.title).toBe("Netflix - Search");
    });
  ...
  describe("Metadata Title", () => {
    ...
    it("should end with Search", () => {
      expect(metadata.title).toMatch(/Search$/);
    });
  });
