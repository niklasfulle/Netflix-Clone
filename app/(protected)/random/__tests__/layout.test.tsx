...
describe("Random Layout (random/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix - Random"', () => {
      expect(metadata.title).toBe("Netflix - Random");
    });
    ...
    it("should have Random text", () => {
      expect(metadata.title).toContain("Random");
    });
  });
  ...
  describe("Metadata Title", () => {
    ...
    it("should end with Random", () => {
      expect(metadata.title).toMatch(/Random$/);
    });
  });
