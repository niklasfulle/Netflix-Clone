...
describe("Changelog Layout (changelog/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix - Changelog"', () => {
      expect(metadata.title).toBe("Netflix - Changelog");
    });
    ...
    it("should have Changelog text", () => {
      expect(metadata.title).toContain("Changelog");
    });
  });
  ...
  describe("Metadata Title", () => {
    ...
    it("should end with Changelog", () => {
      expect(metadata.title).toMatch(/Changelog$/);
    });
  });
