...
describe("Movies Layout (movies/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix - Movies"', () => {
      expect(metadata.title).toBe("Netflix - Movies");
    });
    ...
    it("should have Movies text", () => {
      expect(metadata.title).toContain("Movies");
    });
  });
  ...
  describe("Metadata Title", () => {
    ...
    it("should end with Movies", () => {
      expect(metadata.title).toMatch(/Movies$/);
    });
  });
