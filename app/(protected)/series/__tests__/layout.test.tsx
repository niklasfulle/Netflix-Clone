...
describe("Series Layout (series/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix - Series"', () => {
      expect(metadata.title).toBe("Netflix - Series");
    });
    ...
    it("should have Series text", () => {
      expect(metadata.title).toContain("Series");
    });
  });
  ...
  describe("Metadata Title", () => {
    ...
    it("should end with Series", () => {
      expect(metadata.title).toMatch(/Series$/);
    });
  });
