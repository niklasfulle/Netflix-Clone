...
import Layout, { metadata } from "../../../[movieId]/layout";

describe("Watch Layout (watch/[movieId]/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix"', () => {
      expect(metadata.title).toBe("Netflix");
    });
