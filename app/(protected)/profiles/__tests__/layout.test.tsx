...
describe("Profiles Layout (profiles/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix - Profiles"', () => {
      expect(metadata.title).toBe("Netflix - Profiles");
    });
    ...
    it("should have Profiles text", () => {
      expect(metadata.title).toContain("Profiles");
    });
  });
  ...
  describe("Metadata Title", () => {
    ...
    it("should end with Profiles", () => {
      expect(metadata.title).toMatch(/Profiles$/);
    });
  });
