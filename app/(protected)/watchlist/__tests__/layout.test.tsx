...
describe("Watchlist Layout (watchlist/layout.tsx)", () => {
  ...
  describe("Metadata Configuration", () => {
    ...
    it('should have title "Netflix - Watchlist"', () => {
      expect(metadata.title).toBe("Netflix - Watchlist");
    });
    ...
    it("should have Watchlist text", () => {
      expect(metadata.title).toContain("Watchlist");
    });
  });
  ...
  describe("Metadata Title", () => {
    ...
    it("should end with Watchlist", () => {
      expect(metadata.title).toMatch(/Watchlist$/);
    });
  });
